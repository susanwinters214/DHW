                    ...
                    <div className="inner-column">
                      ...
                      <div className="text">
                        <p>
                          ...
                          by opening the door to see if the light comes on. If
                          you want us to, we can clean out expired food from
                          your refrigerator.
                        </p>{" "}
                        <p>
                          Our{" "}
                          ...
                          deliver and stock your refrigerator and pantry prior
                          to your arrival with a 48 hour notice. (Monday
                          deliveries would need to be requested on the prior
                          Friday.){" "}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="inner-column">
                      ...
                      <div className="text">
                        ...
                        <p>
                          ...
                          view images of the damages a water leak can have on
                          your home.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="content-column col-lg-6 col-md-12 col-sm-12">
                    <div className="inner-column">
                      ...
                      <div className="text">
                        ...
                        your breaker box to see if any breakers have tripped,
                        and if so, we will reset them.
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="content-column col-lg-6 col-md-12 col-sm-12">
                    <div className="inner-column">
                      ...
                      <div className="text">
                        ...
                        ensure no condensation leaks are in the drip pan. (We
                        only enter the attic if it is easily accessible and has
                        been floored for safety.)
                      </div>
                    </div>
                  </div>
                  {/* Image Column */}
                    ...
                    <div className="inner-column">
                      ...
                      <div className="text">
                        <p>
                          ...
                          wireless keypads and remote controllers when needed.
                          We also have experience programming a variety of
                          garage door remotes and handheld or in-car remotes.
                        </p>
                    ...
                    <div className="inner-column">
                      ...
                      <div className="text">
                        <p>
                          ...
                          there. We check for algae growth or debris in and
                          around the pool or fountain. We will make a note of
                          the water level of the pool and include it in your
                          Home Watch Check report.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="row clearfix">
                  ...
                  <div className="content-column col-lg-6 col-md-12 col-sm-12">
                    <div className="inner-column">
                      ...
                      <div className="text">
                        <p>
                          We check all door entries to make sure every one of
                          them is securely locked.
                        </p>

                        <p>
                          If for any reason you need your house re-keyed, we can
                          provide you with the contact information of our
                          priority vendor and meet with them during the process
                          of re-keying your home.
                        </p>
                        <p>
                ...
                <div className="row clearfix">
                  ...
                  <div className="content-column col-lg-6 col-md-12 col-sm-12">
                    <div className="inner-column">
                      <h3>Trash Cans</h3>
                      <div className="text">
                        Leaving trash cans at the curb past your trash pickup
                        day is a sign of an absentee owner. If you left your
                        trash and recycle bins out at the curb when you left
                        town, we will bring them up to the house and place in
                        the garage so that neighbors do not notice you are not
                        home. We also occasionally pull the trash cans to the
                        curb and back up to the house the next day to give the
                  ...
                  <div className="content-column col-lg-6 col-md-12 col-sm-12">
                    <div className="inner-column">
                      ...
                      <div className="text">
                        ...
                        and make sure that every gate or rear entry is secure.
                        We encourage all clients to have locks on all outside
                  ...
                  <div className="content-column col-lg-6 col-md-12 col-sm-12">
                    <div className="inner-column">
                      ...
                      <div className="text">
                        ...
                        checks in your home while you are away. To see a
                        complete list of items we look for during a Home Watch
                        inspection see our{" "}
                        <Link href="/homewatch-checklist">
                          Home Watch Checklist
                        </Link>{" "}
